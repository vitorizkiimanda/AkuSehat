...
if($_POST){
  ...
  $sql = "UPDATE daily_health_data SET tension_sistol = '$tension_sistol', tension_diastol = '$tension_diastol', sleep_duration = '$sleep_duration', daily_description = '$daily_description' WHERE id_pat = {$id_pat} AND date_daily = {$date_daily}";
