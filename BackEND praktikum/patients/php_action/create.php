...
if($_POST) {
  ...
  $sql = "INSERT INTO patients (id_patient,name_patient,email_patient, password_patient, address_patient, sex_patient, bank_patient, no_tel_patient, active) VALUES ('','$name_patient','$email_patient','$password_patient', '$address_patient', '$sex_patient', '$bank_patient', '$no_tel_patient','1')";
