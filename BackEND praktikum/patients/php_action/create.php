   ...
   if($photo_type == "image/jpeg" || $photo_type == "image/png"){
     if($photo_size <= 1000000){
       if(move_uploaded_file($photo_loc, $path)) {
         $sql = "INSERT INTO patients (id_patient,name_patient,email_patient, password_patient, address_patient, sex_patient, bank_patient, no_tel_patient, profile_pict_pat, active) VALUES ('','$name_patient','$email_patient','$password_patient', '$address_patient', '$sex_patient', '$bank_patient', '$no_tel_patient','$new_name','1')";
